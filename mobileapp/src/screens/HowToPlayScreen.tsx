...
const HowToPlayScreen = ({ navigation }: any) => {
  ...
  return (
    <ScrollView style={styles.container}
      ...
      <Text textType='light' style={{ fontSize: 17, marginTop: 10, textAlign: 'justify' }}>
      ...
      <Text textType='light' style={{ fontSize: 17, marginVertical: 10, textAlign: 'justify' }}>
        ...
        {"\n\n"}Valgono i verbi coniugati e solamente le parole nel dizionario italiano. Non valgono i nomi propri. Chi fa più punti ha vinto!
      </Text>
